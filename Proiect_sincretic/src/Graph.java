...
class Graph {
    ...
    void greedyColoring() {
        ...
        // valoare false inseamna ca available[cr] este asignata
        boolean[] available = new boolean[noVertices];

        // la inceput, toate culorile sunt disponibile
        ...
        for (int u = 0; u < noVertices; u++) {
            System.out.println(countries.get(u).getName() + " --->  Culoare " + colours.get(result[u]));
        }
    }
